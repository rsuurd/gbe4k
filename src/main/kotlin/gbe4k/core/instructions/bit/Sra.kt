...
class Sra private constructor(private val source: Any, private val mode: Mode = Mode.DIRECT) : Instruction {
    ...
    override fun execute(cpu: Cpu) {
        ...
        val result = value.shr(1) + value.and(0x80) + value.and(0x1).shl(8)
